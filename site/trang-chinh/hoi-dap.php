<section class="resume-section p-4 p-lg-5 text-center" id="contact">
    <div class="container">
        <div class="my-auto">
            <h2 class="mb-4 primary-color">&lt; liên hệ &gt;</h2>

            <ul class="fa-ul mb-4 ml-0">
                <li id="mail-address">
                    <!--               Replace with your email address -->
                    <i class="fas fa-envelope-open mr-2 contact-icons"></i>hienpt0@gmail.com</a>
                </li>
                <li>
                    <i class="fas fa-mobile-alt mr-2 contact-icons"></i>0846887679
                </li>
                <li>
